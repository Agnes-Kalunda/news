...
export class News extends Component {
  ...
  async handleNext() {
    ...
    let url = `https://newsapi.org/v2/top-headlines?country=${
      this.props.country
    }&category=${this.props.category}&apiKey=4541b7a702df4630afb9e2d6600933e0&page=${
      this.state.pg + 1
  ...
  async componentDidMount() {
    window.scrollTo(0, 0);
    const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=4541b7a702df4630afb9e2d6600933e0&page=1&pageSize=${this.props.pageSize}`;
    this.setState({ loading: true });
    let data = await fetch(url);
    let parsedData = await data.json();
